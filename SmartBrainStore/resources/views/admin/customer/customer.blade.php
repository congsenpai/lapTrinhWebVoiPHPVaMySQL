...
@section('content')
    ...
    <section class="p-3" style="padding-right: 30px">
        <div class="row" style="margin-bottom: 10px;width: 40%;float:right">
            {{-- Tìm kiếm khách hàng --}}
            <form id="searchForm" action="" style="display: flex">
                <input type="text" placeholder="Search by name, email, or phone" name="searchkey" value="{{ request()->query('searchkey')}}" style="margin-right: 10px">
                <button type="submit" style="width: 200px">Tìm kiếm</button>
            </form>
        </div>
        <!-- The Modal -->
        <!-- Modal Update-->
        ...
        <button data-toggle="modal" data-target="#addCustomerModal" id="btnShowModal" style="width: 140px;float:right">Thêm Khách hàng</button>
